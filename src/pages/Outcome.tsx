...
export default function Outcome() {
  ...
  if (isWinner) {
    ...
    description = `With a decisive count of ${myCount} seats, ${myAllianceName} has secured an absolute majority in Parliament. The Yang di-Pertuan Agong has formally invited the coalition leadership to Istana Negara. A new era of governance is set to begin.`;
